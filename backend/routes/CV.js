...
import { createCvController, getCvController, deleteCvController, getAllCvsController } from "../controllers/CV.controller.js";
...
router.get("/getAll/:userId", getAllCvsController)
