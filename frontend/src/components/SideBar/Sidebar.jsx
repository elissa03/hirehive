...
function Sidebar({ handleLogout, setActiveComponent }) {
  ...
  useEffect(() => {
    ...
    // Store active component in localStorage on change
    localStorage.setItem("activeComponent", active);
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        <li className="nav-item">
          <a
            ...
            className={`nav-link ${active === "dashboard" ? styles.active : ""} ${styles.navLink}`}
            aria-current="page"
          >
        ...
        <li className="nav-item">
          <a
            ...
            className={`nav-link ${active === "cvs" ? styles.active : ""} ${styles.navLink}`}
            aria-current="page"
          >
        ...
        <li className="nav-item">
          <a
            ...
            className={`nav-link ${active === "jobs" || active === "exploreJobs" ? styles.active : ""} ${styles.navLink}`}
            aria-current="page"
          >
        ...
        <li className="nav-item">
          <a
            ...
            className={`nav-link ${active === "applications" ? styles.active : ""} ${styles.navLink}`}
            aria-current="page"
          >
            <FontAwesomeIcon icon={faClipboardList} className={styles.icon} /> My Applications
          </a>
        </li>
        ...
        <li>
          <a
            ...
            className={`nav-link ${active === "settings" ? styles.active : ""} ${styles.navLink}`}
          >
        ...
        <li>
          <a
            ...
            className={`nav-link ${active === "account" ? styles.active : ""} ${styles.navLink}`}
          >
